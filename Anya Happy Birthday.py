...
def get_text_messages(message):
    if message.text == '👋Поздороваться':
        ...
        bot.send_message(message.from_user.id, '❤Ты на правильном пути, становись только лучше, пусть в геометрической прогрессии растёт количесвто клиентов! С Днём Рождения!', parse_mode='Markdown')
