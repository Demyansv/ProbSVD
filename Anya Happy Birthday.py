...
def get_text_messages(message):
    if message.text == '👋Поздороваться':
        ...
        bot.send_message(message.from_user.id, '❤Пусть твой дом наполняет любовь, у тебя и твоих родных будет крепкое здоровье и в твоей семье царит гармония!', parse_mode='Markdown')
